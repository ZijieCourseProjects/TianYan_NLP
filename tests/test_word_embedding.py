...
class MyTestCase(unittest.TestCase):
    ...
    def test_wordEncoding2(self):
        ...
        true_ans = ['abundance', 'art', 'bear', 'beautys', 'bright', 'bud', 'buriest', 'churl', 'content',
                    'contracted', 'creatures', 'cruel', 'decease', 'desire', 'die', 'due', 'eat', 'else', 'eyes',
                    'fairest',
                    'famine', 'feedst', 'flame', 'foe', 'fresh', 'fuel', 'gaudy', 'glutton', 'grave', 'heir', 'herald',
                    'increase', 'lies', 'lights', 'making', 'makst', 'memory', 'might', 'never', 'niggarding',
                    'ornament',
                    'own', 'pity', 'riper', 'rose', 'self', 'selfsubstantial', 'spring', 'sweet', 'tender', 'thee',
                    'thereby',
                    'thine', 'thou', 'thy', 'time', 'waste', 'world', 'worlds', 'alleating', 'answer', 'asked',
                    'beauty',
                    'besiege', 'blood', 'brow', 'child', 'cold', 'couldst', 'count', 'days', 'deep', 'deservd', 'dig',
                    'excuse', 'fair', 'feelst', 'field', 'forty', 'gazed', 'held', 'livery', 'lusty', 'made', 'make',
                    'mine',
                    'new', 'old', 'praise', 'proud', 'proving', 'say', 'shall', 'shame', 'small', 'succession', 'sum',
                    'sunken',
                    'tatterd', 'thriftless', 'treasure', 'trenches', 'warm', 'weed', 'winters', 'worth', 'youths',
                    'age',
                    'another', 'april', 'back', 'beguile', 'calls', 'despite', 'dies', 'disdains', 'dost', 'face',
                    'fond',
                    'form', 'glass', 'golden', 'husbandry', 'image', 'live', 'look', 'lovely', 'mother', 'mothers',
                    'posterity',
                    'prime', 'rememberd', 'renewest', 'repair', 'selflove', 'shalt', 'single', 'stop', 'tell',
                    'tillage',
                    'tomb', 'unbless', 'uneard', 'viewest', 'whose', 'windows', 'womb', 'wrinkles', 'abuse',
                    'acceptable',
                    'alone', 'audit', 'beauteous', 'bequest', 'bounteous', 'canst', 'deceive', 'doth', 'executor',
                    'frank',
                    'free', 'give', 'gives', 'gone', 'great', 'largess', 'leave', 'legacy', 'lend', 'lends', 'lives',
                    'loveliness', 'nature', 'natures', 'niggard', 'nothing', 'profitless', 'spend', 'sums', 'th',
                    'tombed',
                    'traffic', 'unthrifty', 'unused', 'upon', 'usurer', 'why', 'yet', 'bareness', 'bereft', 'checked',
                    'confounds', 'distillation', 'distilld', 'dwell', 'effect', 'every', 'excel', 'eye', 'fairly',
                    'flowers',
                    'frame', 'frost', 'gaze', 'gentle', 'hideous', 'hours', 'leads', 'leaves', 'leese', 'left',
                    'liquid',
                    'meet', 'neverresting', 'nor', 'oersnowed', 'pent', 'play', 'prisoner', 'quite', 'remembrance',
                    'same',
                    'sap', 'show', 'still', 'substance', 'summer', 'summers', 'though', 'tyrants', 'unfair', 'walls',
                    'winter',
                    'work', 'breed', 'conquest', 'death', 'deaths', 'deface', 'depart', 'ere', 'forbidden', 'hand',
                    'happier',
                    'happies', 'leaving', 'let', 'living', 'loan', 'pay', 'place', 'ragged', 'refigurd', 'selfkilld',
                    'selfwilld', 'shouldst', 'ten', 'thats', 'times', 'usury', 'vial', 'willing', 'worms', 'adore',
                    'attending',
                    'burning', 'car', 'climbd', 'converted', 'day', 'diest', 'duteous', 'feeble', 'fore', 'get',
                    'gracious',
                    'head', 'heavenly', 'highmost', 'hill', 'homage', 'lifts', 'light', 'like', 'lo', 'looks', 'low',
                    'majesty',
                    'middle', 'mortal', 'newappearing', 'noon', 'orient', 'outgoing', 'pilgrimage', 'pitch', 'reeleth',
                    'resembling', 'sacred', 'serving', 'sight', 'son', 'steepup', 'strong', 'thyself', 'tract',
                    'unless',
                    'unlookd', 'up', 'way', 'weary', 'youth', 'annoy', 'chide', 'concord', 'delights', 'ear', 'gladly',
                    'happy',
                    'hear', 'hearst', 'husband', 'joy', 'lovst', 'many', 'mark', 'married', 'music', 'mutual', 'none',
                    'note',
                    'offend', 'ordering', 'parts', 'pleasing', 'pleasure', 'prove', 'receivst', 'sadly', 'seeming',
                    'sing',
                    'singleness', 'sings', 'sire', 'song', 'sounds', 'speechless', 'strikes', 'string', 'sweetly',
                    'sweets',
                    'true', 'unions', 'war', 'welltuned', 'wilt', 'ah', 'behind', 'bosom', 'childrens', 'commits',
                    'consumst',
                    'destroys', 'end', 'enjoys', 'fear', 'hap', 'hast', 'hath', 'husbands', 'issueless', 'keep', 'kept',
                    'life',
                    'love', 'makeless', 'mind', 'murdrous', 'others', 'private', 'shape', 'shifts', 'sits', 'toward',
                    'unthrift',
                    'user', 'wail', 'weep', 'well', 'wet', 'widow', 'widows', 'wife', 'bearst', 'belovd', 'change',
                    'chief',
                    'conspire', 'deny', 'evident', 'fairer', 'gainst', 'grant', 'hate', 'kind', 'kindhearted', 'least',
                    'lodgd',
                    'murderous', 'possessd', 'presence', 'roof', 'ruinate', 'seeking', 'stickst', 'thought',
                    'unprovident']
        self.assertTrue(a)
        self.assertTrue(b)
        temp = []
    ...
    def test_doc2sequence2(self):
        ...
        ans = [[198, 201, 233, 276, 327, 338, 100, 100, 100, 100], [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
               [136, 276, 373, 100, 100, 100, 100, 100, 100, 100]]

    def test_readWordEmbedding(self):
        wv = readWordEmbedding('../embed/pretrained_model.bin')
        a, b = False, False
    ...
    def test_ind2word(self):
        ...
        self.assertEqual(ind2word(wv, [378, 1226, 338, 999, 93, 367]),
                         ['building', 'victorian', 'secretary', 'hold', 'very', 'winds'])
    ...
    def test_word2ind(self):
        ...
        self.assertEqual(word2ind(wv, ['building', 'victorian', 'secretary', 'hold', 'very', 'winds']),
                         [378, 1226, 338, 999, 93, 367])
    ...
    def test_isVocabularyWord(self):
        ...
        self.assertEqual(isVocabularyWord(wv, ['emperor', 'victorian', 'secretary', 'hsaiu', 'very', 'guard']),
                         [0, 1, 1, 0, 1, 1])
    ...
    def test_trainwordEmbedding(self):
        ...
        self.assertEqual(wv.index_to_key,
                         ['thou', 'thy', 'thee', 'self', 'thine', 'art', 'beauty', 'world', 'beautys', 'ten', 'still',
                          'doth', 'why', 'dost', 'another', 'sweet'])
        self.assertEqual(wv1.index_to_key,
                         ['thou', 'thy', 'thee', 'self', 'thine', 'art', 'beautys', 'beauty', 'world', 'another', 'why',
                          'doth', 'still', 'ten', 'sweet', 'dost', 'make', 'love', 'eyes', 'time', 'age', 'shall',
                          'fair', 'shame', 'treasure', 'every', 'eye', 'single', 'live', 'look', 'glass', 'times',
                          'whose', 'own', 'die', 'sum', 'might', 'old', 'face', 'form', 'lies', 'child', 'praise',
                          'deep', 'winters', 'repair', 'else', 'tender', 'heir', 'waste', 'bear', 'fresh', 'worlds',
                          'lusty', 'change', 'mother', 'sweets', 'happier', 'shouldst', 'gracious', 'looks',
                          'resembling', 'like', 'thyself', 'music', 'joy', 'posterity', 'lovst', 'receivst', 'many',
                          'wilt', 'prove', 'none', 'widow', 'mind', 'place', 'ere', 'distilld', 'nor', 'calls',
                          'lovely', 'hate', 'shalt', 'golden', 'spend', 'beauteous', 'yet', 'canst', 'gone', 'unused',
                          'lives', 'gentle', 'summer', 'winter', 'confounds', 'left', 'desire'])
        self.assertEqual(wv2.index_to_key,
                         ['thou', 'thy', 'thee', 'self', 'thine', 'art', 'beauty', 'world', 'beautys', 'ten', 'still',
                          'doth', 'why', 'dost', 'another', 'sweet'])
